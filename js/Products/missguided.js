const productMissguided = () => {
    var store = 'missguided';
    var available = true;
    var priceStr = $('.product-essential__title .price').first().text();
    ...
    var title = $('.product-essential__title .product-essential__name').first().text();
    title = title.replace("'", '');
    ...
    var imageUrl = $('.product-images-list__item--active img').attr('src');
